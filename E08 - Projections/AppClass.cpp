...
void Application::InitVariables(void)
{
	...
	m_sProgrammer = "Tyler Machanic - trm2418@rit.edu";
...
void Application::Display(void)
{
	...
	case 3:
		m_pCamera->ResetCamera();
		m_pCamera->SetUp(vector3(0, 0, -1.0));
		m_pCamera->SetPosition(vector3(20, 0, 0));
		break;
	case 4:
		m_pCamera->ResetCamera();
		m_pCamera->SetPosition(vector3(0, 0, -13));
		break;
	case 5:
		m_pCamera->ResetCamera();
		m_pCamera->SetPosition(vector3(0, 0, -13));
		m_pCamera->SetNearFar(vector3(3, 15, 0));
		break;
	case 6:
		m_pCamera->ResetCamera();
		m_pCamera->SetPosition(vector3(0, 0, -13));
		m_pCamera->SetNearFar(vector3(2, 10, 0));
		break;
	case 7:
		m_pCamera->ResetCamera();
